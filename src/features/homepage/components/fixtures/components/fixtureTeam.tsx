...
function FixtureTeam ({teamLogo, teamName, side} : FixtureTeamProps) {
  return (
    ...
    {
    side === 'home' ?
    <div className={`flex flex-col justify-end w-full items-center h-full gap-2 md:flex-row`}>
      ...
      <div className="relative w-full h-4 overflow-hidden text-ellipsis whitespace-nowrap">
        <span className={`text-center min-w-min absolute left-1/2 -translate-x-1/2 top-0 md:right-0 md:-translate-x-0 
