...
function LeagueHeader ({ leagueInfo }: LeagueHeaderProps) {
  ...
  return (
    <div className="flex items-center justify-between w-full gap-4 bg-gray-700 rounded-b-md">
      <div className="flex items-center gap-4">
        <img className="h-10 pl-2 pr-2 bg-white" src={leagueInfo.league.logo} alt="league-logo"/>
        <p className="text-2xl font-semibold text-white font-display ">{leagueInfo.league.name}</p>
      </div>
