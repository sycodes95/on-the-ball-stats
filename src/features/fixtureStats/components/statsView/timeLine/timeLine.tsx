    ...
    <div className="flex flex-col items-center w-full gap-2">
      ...
      fixture.events?.map((ev, index) => (
        <div className="w-full gap-2 timeline-grid" key={index}>
          ...
          <div className="flex justify-center w-full col-start-2 text-white h-full6">
            <span className="w-8 h-6 p-1 text-center rounded-md bg-slate-400">{ev.time.elapsed}'</span>
          </div>
